...
$mapa_estados = [
    ...
    'Apure' => [
        'img' => 'IMG/estados/Apure.png',
        'botones' => [
            ['texto' => '1', 'leyenda' => '1 - Barrio Antonio José de Sucre', 'asamblea' => 'BARRIO ANTONIO JOSÉ DE SUCRE'],
            ['texto' => '2', 'leyenda' => '2 - El Negro', 'asamblea' => 'El Negro'],
            ['texto' => '3', 'leyenda' => '3 - Elorza', 'asamblea' => 'Elorza'],
            ['texto' => '4', 'leyenda' => '4 - Guasdualito', 'asamblea' => 'Guasdualito'],
            ['texto' => '5', 'leyenda' => '5 - San Fernando', 'asamblea' => 'San Fernando'],
    ...
    'Aragua' => [
        ...
        'botones' => [
            ...
            ['texto' => '2', 'leyenda' => '2 - CARMEN DE CURA', 'asamblea' => 'CARMEN DE CURA'],
            ['texto' => '3', 'leyenda' => '3 - COROMOTO', 'asamblea' => 'COROMOTO'],
            ['texto' => '4', 'leyenda' => '4 - DIEZ DE DICIEMBRE', 'asamblea' => 'DIEZ DE DICIEMBRE'],
    ...
    'Guárico' => [
        'img' => 'IMG/estados/Guárico.png',
        'botones' => [
            ['texto' => '1', 'leyenda' => '1 - Altagracia de Orituco', 'asamblea' => 'Altagracia de Orituco'],
            ['texto' => '2', 'leyenda' => '2 - San Juan de los Morros', 'asamblea' => 'SAN JUAN DE LOS MORRROS'],
...
<head>
    ...
    <style>
        ...
        /*--Guárico--*/
        .Guárico-1 { top: 12%; left: 52%; }
        .Guárico-2 { top: 8%;  left: 28%; }
        .Guárico-3 { top: 24%; left: 30%; }
        .Guárico-4 { top: 38%; left: 58%; }
        .Guárico-5 { top: 30%; left: 72%; }

        @media only screen and (max-width: 768px) {
        .Guárico-1 { top: 12%; left: 50%; }
        .Guárico-2 { top: 8%;  left: 22%; }
        .Guárico-3 { top: 24%; left: 26%; }
        .Guárico-4 { top: 38%; left: 60%; }
        .Guárico-5 { top: 30%; left: 76%; }
        }
...
<body>
        ...
        <?php if (isset($mapa_estados[$estado])): ?>
            <div class="mapa-contenedor-flex">
                ...
                <div class="mapa-container">
                    <img src="https://directorioasambleasvzla.com/iconos/<?php echo htmlspecialchars($mapa_estados[$estado]['img']); ?>" alt="Mapa de <?php echo htmlspecialchars($estado); ?>">
    ...
    <script>
        ...
        // Código de debugging - mostrar todas las asambleas cargadas
        console.log("=== TODAS LAS ASAMBLEAS CARGADAS ===");
        Object.keys(iglesiasData).forEach(key => {
            console.log("Clave en BD:", key, "| Longitud:", key.length);
        });
        ...
        function mostrarDetallesPorAsamblea(asamblea) {
            ...
            console.log("Asamblea buscada:", asamblea);
            
            // Normalizar el nombre de la asamblea para búsqueda
            const claveBusqueda = asamblea.trim().toUpperCase()
                .replace(/[ÁÀÄÂÁ]/g, 'A')
                .replace(/[ÉÈËÊ]/g, 'E')
                .replace(/[ÍÌÏÎ]/g, 'I')
                .replace(/[ÓÒÖÔ]/g, 'O')
            ...
            console.log("Clave de búsqueda normalizada:", claveBusqueda);
            console.log("Datos disponibles:", Object.keys(iglesiasData));

            // Buscar coincidencia exacta
            let data = iglesiasData[claveBusqueda];
            ...
            const claves = Object.keys(iglesiasData);
            ...
            for (let clave of claves) {
                ...
                console.log("Comparando:", claveBusqueda, "con", claveNormalizada);
                
                if (claveNormalizada === claveBusqueda) {
                    claveEncontrada = clave;
                    console.log("✅ Coincidencia EXACTA después de normalización");
                    break;
                }
                
                // Coincidencia parcial (contiene)
                if (claveNormalizada.includes(claveBusqueda) || claveBusqueda.includes(claveNormalizada)) {
                    claveEncontrada = clave;
            ...
            if (claveEncontrada) {
                data = iglesiasData[claveEncontrada];
                console.log("Asamblea encontrada:", claveEncontrada);
                mostrarDetalles(data);
            } else {
                console.error("❌ No se encontró información para:", claveBusqueda);
                alert("No se encontró información para la asamblea: " + asamblea + "\n\nClave buscada: " + claveBusqueda);
            }
        }
